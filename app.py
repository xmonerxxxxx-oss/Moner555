...
15. *** ممنوع منعاً باتاً *** استخدام أي متغير معرّف خارج apply_styling بداخلها.
    مثال خاطئ: for row in ws.iter_rows(..., max_row=len(df_موظفين)+1)  ← خطأ لأن df_موظفين غير موجود داخل الدالة
    مثال صحيح: for row in ws.iter_rows(min_row=2, max_row=ws.max_row, max_col=ws.max_column)
16. كل المتغيرات اللي تحتاجها apply_styling لازم تُعرَّف جوّاها مباشرة — لا تستخدم أي متغير من خارجها أبداً.
